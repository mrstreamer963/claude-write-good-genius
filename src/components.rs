...
///
/// **Причина плена — рана, а не чей-то умысел.** Кота оставили там, потому что
/// он не мог уйти со всеми, поэтому в плен он уходит выбывшим (ниже порога
/// `hurt`) и возвращается прямо в лазарет. Само время в плену не стоит ему
/// ничего: там его не калечат — но и не лечат, как и в поле (§12.22).
///
